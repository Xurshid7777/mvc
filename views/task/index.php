        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                if(isset($_GET['sort']) && isset($_GET['sorttype'])){
                    for ($i=1; $i<=$pages; $i++) {
                        echo "<li class=\"page-item\"><a class=\"page-link\" href=\"/task/index?page=$i&sort={$_GET['sort']}&sorttype={$_GET['sorttype']}\">$i</a></li>";
                    }
                }else{
                    for ($i=1; $i<=$pages; $i++) {
                        echo "<li class=\"page-item\"><a class=\"page-link\" href=\"/task/index?page=$i\">$i</a></li>";
                    }
                }
